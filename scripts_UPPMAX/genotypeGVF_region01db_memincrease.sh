...
#SBATCH -e GenotypeGVCF_reg01_%j.err  # Standard error file, %j will be replaced with job ID
#SBATCH -o GenotypeGVCF_reg01_%j.out  # Standard output file, %j will be replaced with job ID
...
gatk --java-options "-Xmx72g" GenotypeGVCFs \
     ...
     -all-sites \
     --output ../Pijimae.region01.allsitesNew.vcf.gz \
